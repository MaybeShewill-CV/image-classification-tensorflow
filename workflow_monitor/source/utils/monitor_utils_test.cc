...
class MonitorUtilsTest : public testing::Test {
protected:
    void SetUp() override {
        puts("SetUp()");
    }
...
TEST_F(MonitorUtilsTest, Test_Getlatestcheckpoint) {
    std::string model_dir = "./model/resnet_ilsvrc_2012";
    std::string checkpoint_model_path;
    std::string checkpoint_model_path_gt = "./model/resnet_ilsvrc_2012/resnet_val_acc=0.3295.ckpt-8";
