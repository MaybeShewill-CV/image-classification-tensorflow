...
|  ----  | :----:  |  :----:  | :----:  |  :----:  | :----: | :----:  |  :----:  |
| .42.198 | Xception | 128 | 5 | 0.01 | 24 | SGD | 0.69573 / 92 |
...
|  机器ip   | 模型名称  |  Total Epoch   | WarmUp Epoch  |  Init LR   |  BS  | Optimizer  |  Eval Stat/Epoch |
|  ----  | :----:  |  :----:  | :----:  |  :----:  | :----: | :----:  |  :----:  |
| .42.202 | VGG-16 | 192 | 5 | 0.0125 | 32 | SGD | 0.62746 / 120 |
| .42.203 | ResNet-101 | 192 | 5 | 0.0125 | 32 | SGD | 0.62686/ 76 |
...
|  机器ip   | 模型名称  |  Total Epoch   | WarmUp Epoch  |  Init LR   |  BS  | Optimizer  |  Eval Stat/Epoch |
|  ----  | :----:  |  :----:  | :----:  |  :----:  | :----: | :----:  |  :----:  |
| .42.204 | DenseNet-121 | 96 | None | 0.0075 | 16 | SGD | 0.60570 / 16 |
| .42.211 | ResNet-50 | 128 | 5 | 0.0075 | 24 | SGD | 0.58571 / 28 |
| .42.212 | MobileNetV2 | 192 | 5 | 0.02 | 64 | SGD | 0.67629 / 140 |