...
| .42.203 | ResNet-101 | 192 | 5 | 0.0125 | 32 | SGD | 0.74292/ 172 |
...
| .58.249 | DarkNet53 | 128 | 5 | 0.01 | 32 | SGD | 0.71665 / 48 |

|  机器ip   | 模型名称  |  Total Epoch   | WarmUp Epoch  |  Init LR   |  BS  | Optimizer  |  Eval Stat/Epoch |
|  ----  | :----:  |  :----:  | :----:  |  :----:  | :----: | :----:  |  :----:  |
| .42.202 | VGG-16 | 96 | 5 | 0.01 | 32 | SGD | 0.59407 / 28 |
...
|  机器ip   | 模型名称  |  Total Epoch   | WarmUp Epoch  |  Init LR   |  BS  | Optimizer  |  Eval Stat/Epoch |
|  ----  | :----:  |  :----:  | :----:  |  :----:  | :----: | :----:  |  :----:  |
| .42.204 | DenseNet-121 | 128 | 5 | 0.025 | 32 | SGD | 0.66120 / 36 |
| .42.211 | ResNet-50 | 128 | 5 | 0.025 | 32 | SGD | 0.52339 / 44 |
| .42.212 | MobileNetV2 | 96 | None | 0.01 | 64 | SGD | 0.67841 / 96 |

|  机器ip   | 模型名称  |  Total Epoch   | WarmUp Epoch  |  Init LR   |  BS  | Optimizer  |  Eval Stat/Epoch |
|  ----  | :----:  |  :----:  | :----:  |  :----:  | :----: | :----:  |  :----:  |
| .42.198 | Xception | 128 | 5 | 0.05 | 24 | SGD | 0.61987 / 4 |
| .42.199 | Res2Net | 128 | 5 | 0.02 | 24  | SGD | None / None |
| .42.212 | MobileNetV2 | 128 | 5 | 0.05 | 64 | SGD | 0.67831 / 64 |
